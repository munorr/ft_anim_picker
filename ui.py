...
class AnimPickerWindow(QtWidgets.QWidget):
    def __init__(self, parent=None):
        ...
        self.resize_range = 10  # Pixels from edge where resizing is active
    ...
    def setup_ui(self):
        ...
        self.canvas_tab_frame.setStyleSheet(f'''QFrame {{border: 0px solid gray; border-radius: 12px; background-color: rgba(36, 36, 36, .8);}}''')
        ...
        #self.canvas_tab_frame_scroll_area.setFixedWidth(160)  # Set a fixed width for the scroll area
        self.canvas_tab_frame_scroll_area.setFixedHeight(24)
        #self.canvas_tab_frame_scroll_area.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAsNeeded)
    ...
    def setup_layout(self):
        ...
        #self.bottom_col.addWidget(self.namespace_dropdown)
        #self.bottom_col.addWidget(self.canvas_util_frame)
        #self.canvas_util_frame_col.addWidget(self.image_opacity_slider)
